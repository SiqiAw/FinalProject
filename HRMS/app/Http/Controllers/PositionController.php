...
class PositionController extends Controller
{
    function create()
    {
        return view('admin.settings.addposition');
    }
    ...
    function show()
    {
        ...
        return view('admin.settings.positionpage')->with('positions', $positions);
    }

    function edit($id)
    {
        $positions = Position::find($id);
        return view('admin.settings.editposition', compact('positions','id'));
    }
