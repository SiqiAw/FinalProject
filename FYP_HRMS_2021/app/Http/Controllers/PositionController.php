...
class PositionController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.addPosition');
    }
    ...
    function show()
    {
        ...
        return view('admin.system-settings.positionpage')->with('positions', $positions);
    }

    function edit($id)
    {
        $positions = Position::find($id);
        return view('admin.system-settings.editposition', compact('positions','id'));
    }
