...
class NationalityController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.addnational');
    }
    ...
    function show()
    {
        ...
        return view('admin.system-settings.nationalpage')->with('nationalities', $nationalities);
    }

    function edit($id)
    {
        $nationalities = Nationality::find($id);
        return view('admin.system-settings.editnational', compact('nationalities','id'));
    }
