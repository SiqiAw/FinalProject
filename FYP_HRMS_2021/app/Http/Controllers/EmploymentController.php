...
class EmploymentController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.addemployment')->with('workingtimes', Workingtime::all());
    }
    ...
    function show()
    {
        ...
        return view('admin.system-settings.employmentpage')->with('employments', $employments)
