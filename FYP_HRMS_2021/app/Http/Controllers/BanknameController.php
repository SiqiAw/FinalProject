...
class BanknameController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.addbankname');
    }
    ...
    function show()
    {
        ...
        return view('admin.system-settings.banknamepage')->with('banknames', $banknames);
    }

    function edit($id)
    {
        $banknames = Bankname::find($id);
        return view('admin.system-settings.editbankname', compact('banknames','id'));
    }
