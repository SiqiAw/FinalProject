...
class DepartmentController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.adddepartment');
    }
    ...
    function show()
    {
        ...
        return view('admin.system-settings.departmentpage')->with('departments', $departments);
    }

    function edit($id)
    {
        $departments = Department::find($id);
        return view('admin.system-settings.editdepartment',compact('departments','id'));
    }
