...
class StateController extends Controller
{
    ...
    function create()
    {
        return view('admin.system-settings.addstate');
    }
    ...
    {
        $states = State::all();
        return view('admin.system-settings.statepage')->with('states', $states);
    }

    function edit($id)
    {
        $states = State::find($id);
        return view('admin.system-settings.editstate', compact('states','id'));
    }
